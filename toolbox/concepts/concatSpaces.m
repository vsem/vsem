...
% concat Cocatenate two spaces
%	combinedSpace = concat(space1, space2) 
% combines two spaces via concatenation. 
% First, only the concepts that are in common between the two
% given spaces are retained. Second, the vectors of the two
% spaces are independently normalized (v/norm(v)). Finally, the two
% matrices are concatenated and a new space is generated.
%
