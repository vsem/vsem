function [features info] = Image2DenseColourNamePatches(im, nP)
...
colourNameIm = Rgb2ElevenColourNames(im, true);
...
arrayA = DiagMatrixLinear(n, newR);
arrayB = DiagMatrixLinear(newC, m);
...
info = GetDenseInfoStructure(imSize, n, m, nP);
