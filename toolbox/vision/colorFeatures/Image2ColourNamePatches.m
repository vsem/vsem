...
[descr inf] = Image2DenseColourNamePatches(imrgb, numPixels);

% This glues individual bins together
[descT{1} infoT{1}] = Feature2Spatial(descr, inf, numBins);
...
for idx = 2:5 
    ...
    [descr inf] = Image2DenseColourNamePatches(imrgb, numPixels);
    [descT{idx} infoT{idx}] = Feature2Spatial(descr, inf, numBins);
