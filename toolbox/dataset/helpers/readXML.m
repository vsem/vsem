function rec = readXML(path)
% readXML xml reader wrapper
%	readXML(path) returns the content of an xml in a structure. It is a
%	wrapper around two different VOCdevkit functions.
